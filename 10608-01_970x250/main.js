...
function animate() {
  ...
  tl1.to(['#turtle', '#turtle-shadow'], 1.25,{ x: '+=970', ease: "power1.out" }, 0);
  tl1.to(['#turtle', '#turtle-shadow'], 0.75,{ y: '-=75', ease: "power1.out" }, 0);
  tl1.staggerTo(['.headline'], 1.25,{ scale: 1, y: '-=75', x: '+=970', ease: "power1.out" }, 0.1, 0);

  tl1.to(['#frame-left'], 1,{ x: '+=100', ease: "power1.out" }, '+=0');
  tl1.to(['#frame-right'], 1,{ x: '-=100', ease: "power1.out" }, '<');
  tl1.to(['#frame-bottom'], 1,{ x: '+=200', ease: "power1.out" }, '<');
