...
function animate() {
  ...
  tl1.set(["#turtle-shadow"], { x:"15px", y:"-7px" });
  
  tl1.to(['#turtle', '#turtle-shadow'], 1,{  y: '-=35', x: '+=160', ease: "power1.out" }, 0);
  tl1.staggerTo(['.headline'], 0.5,{ scale: 1, autoAlpha:1,  ease: "back.out(1.1)" }, 0.12, 0);
